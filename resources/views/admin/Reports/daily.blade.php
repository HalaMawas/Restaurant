                    ...
                    <div class="card">
                        ...
                        <div class="card-body collapse in">
                            <div class="card-block">
                                ...
                                <form class="form" action="{{url('order')}}" method="GET"
                                           ...
                                           <!--  <div class="col-md-6">
                                                <div class="form-group" >
                                                    ...
                                                    <select  name="restaurant" id="restaurant"
                                                        ...
                                                        <option value="" selected>All Restaurants
                                                        </option>
                                                        @foreach($restaurants as $restaurant)
                                                            <option value="{{$restaurant->id}}" @if(app('request')->input('restaurant')==$restaurant->id) selected @endif>{{$restaurant->name}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div> -->
                                            <div class="col-md-6">
                                                <div class="form-group" >
                                                    ...
                                                    <select  name="customer" id="customer"
                                                             class="form-control js-example-basic-single" >
                                                        <option value="" selected>جميع الزبائن
                                                        </option>
                                                        @foreach($customers as $customer)
                                                            <option value="{{$customer->id}}" @if(app('request')->input('customer')==$customer->id) selected @endif>{{$customer->first_name.' '.$customer->last_name}}</option>
                                                        @endforeach
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <!-- <td>{{$order->meals->first()->menu->restaurant->name}}</td> -->
															...
															<!-- 	<td>
                                                                ...
                                                                <td>  <a href="{{url("order/{$order->id}")}}" type="button" class="btn btn-primary edit" style="border:0px;" ><i class="icon-edit"></i>
                                                                    </a></td>
                                                            </tr>
                                                            @endforeach
                                                            @endif

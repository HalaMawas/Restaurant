...
@section('style')
    <link rel="stylesheet" href="{{asset('admin-plugins/nice-select2.css')}}">
           <style>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body collapse in">
                            ...
                            <div class="card-block">
                                ...
                                <div class="card-body">
                                    <form method="POST" action="{{url('/updaterole')}}" enctype="multipart/form-data">
                                ...
                                @endif
                                        <div class="row">
                                            <div class="form-group col-md-5" data-route="{{url("api/getCategory")}}">
                                                <label class="bmd-label-floating">الصلاحية</label>
                                                <select id="role_id" name="role_id" data-route="{{url('api/selectrole')}}"
                                                        required>
                                                    <option value="0" selected="">اخنر الصلاحية</option>
...
<script src="{{asset('admin-plugins/treeview/UpdateGroup.js')}}"></script>
    <script>
        var APP_URL = {!! json_encode(url('/permission')) !!}
        $('[href="' + APP_URL + '"]').parent().addClass('active');

    </script>
    <script src="{{asset('admin-plugins/nice-select2.js')}}"></script>

    <script>

        NiceSelect.bind(document.getElementById("role_id"));

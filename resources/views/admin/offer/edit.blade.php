                    ...
                    <div class="card">
                        ...
                        <div class="card-body collapse in">
                            <div class="card-block">
                                ...
                                <form class="form" action="{{url("offer/{$offer->id}")}}" method="POST"
                                    ...
                                    <div class="form-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select id="projectinput5" name="meal"
                                                        ...
                                                        @foreach($meals as $meal)
                                                            <option value="{{$meal->id}}"  @if($offer->meal_id==$meal->id) selected @endif>{{$meal->name_en}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="position-relative has-icon-left">
                                                        <input type="number" id="price" class="form-control"
                                                               placeholder="سعر العرض"  value="{{$offer->price}}" name="price" required>
                                        ...
                                        <div class="row">
                                            ...
                                            <input type="date" id="issueinput3" class="form-control" name="to_date" data-toggle="tooltip" value="{{$offer->to_date}}" data-trigger="hover" data-placement="top" data-title="تاريخ العرض">
                                        </div>
                                                </div>
                                            </div>
                                        </div>

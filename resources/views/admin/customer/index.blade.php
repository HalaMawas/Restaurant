        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-xs-12 mb-1">
                    <h2 class="content-header-title">Edit Customer</h2>
                </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered mb-0"  id="example">
                                        ...
                                        @foreach($customers as $key=>$customer)
                                            <tr data-route="{{url("customer/{$customer->id}")}}">
                                                <td>{{$key+1}}</td>
                                                ...
                                                <td>
   <a href="{{url("customer/{$customer->id}")}}" type="button" class="btn btn-primary edit" style="border:0px;" ><i class="icon-edit"></i>
                                                    </a>
                                                </td>
                                                <td>
                                                    <a type="button" class="btn btn-danger delete" style="border:0px;" data-toggle="modal" data-target="#small"><i class="icon-ios-trash"></i>
                                                    </a>
                                                </td>
                                            </tr>
                                        @endforeach
            ...
            <div class="modal-dialog modal-sm" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel19">Delete Restaurant</h4>
                    </div>
...
@section('script')
    {{--/* for active sidebar*/--}}
    <script>
        var APP_URL = {!! json_encode(url('/customer')) !!}

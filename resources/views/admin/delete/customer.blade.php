        ...
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel19">Recovery Customer</h4>
                </div>
                <div class="modal-body">
                    <h5>Are you sure you want to Recovery this Customer ?!</h5>
                </div>
...
@section('script')
    ...
    {{--/* for active sidebar*/--}}
    <script>
        var APP_URL = {!! json_encode(url('/deleted_customer')) !!}

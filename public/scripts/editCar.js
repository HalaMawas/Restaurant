...
$(document).ready(function () {
    ...
    $('td').on('click', 'button.edit', function () {
        ...
        $(this).closest('tr').find('td:nth-child(2)').html('<input type="text" class="form-control" style="width:100%" value="' + name + '">');
        $(this).remove();
    });
    ...
    $('td').on('click', 'button.cancel', function () {
        ...
        $(this).parents('tr').find('td:nth-child(2)').text(name);
    ...
    $('td').on('click', 'button.save', function () {
        ...
        var new_name = _this.find('td:nth-child(1) input').val();
        ...
        $.post(url, data, function (res) {
            if (res.success == true) {
                ...
                _this.find('td:nth-child(1)').html(new_name);
            } else {
                new PNotify({
                    title: "Wrong!",
                    text: res.msg,
